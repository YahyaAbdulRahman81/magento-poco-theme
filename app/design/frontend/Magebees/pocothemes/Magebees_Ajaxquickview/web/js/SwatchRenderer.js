...
define(['jquery', 'underscore',  'jquery-ui-modules/core',
	'jquery-ui-modules/widget',,'quickviewSwatchRenderer'], function ($, _) {
    'use strict';
...
params[k] = v; }
     ...
     */
    $.widget('magebees_ajaxquickview.quickviewSwatchRenderer', {
        options: {
            classes: {
            ...
            productId:{},
            mediaGallerySelector: '[data-gallery-role=gallery-placeholder-quickview]',
            selectorProduct: '#product_quickview_content',             // selector of parental block of prices and swatches (need to know where to seek for price block)
        ...
        _create: function () {
            ...
            var options = this.options,
                gallery = $('[data-gallery-role=gallery-placeholder-quickview]', '.product.media'),
        ...
        _ProductMediaCallback: function ($this, response) {
            ...
            var
                $widget = this,
                 $main = $this.parents('#product_quickview_content'),
                images = [],
                support = function (e) {
            ...
            this.updateBaseImage(images,$main);
        },
         ...
         */
        updateBaseImage: function (images,context) {
             ...
             var justAnImage = images[0],
                ...
                console.log('this.options.mediaGallerySelector');
				console.log(this.options.mediaGallerySelector);
				if (typeof(gallery) != "undefined"){
				gallery.updateData(imagesToUpdate);	
				}else{
					console.log('gallery undefined 801');
				}
                if (isInitial) {
                ...
                gallery.first();
					...
					console.log('gallery undefined 809');
				}
...
size++; }
    ...
    return $.magebees_ajaxquickview.quickviewSwatchRenderer;
});

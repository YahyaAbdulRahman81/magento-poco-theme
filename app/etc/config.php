...
return [
    'modules' => [
        ...
        'Magebees_Advertisementblock' => 1,
        'Magebees_AjaxCategoryProducts' => 1,
        'Magebees_AjaxInfiniteScroll' => 1,
        'Magebees_Ajaxaddtocart' => 1,
        'Magebees_Ajaxcomparewishlist' => 1,
        'Magebees_Ajaxquickview' => 1,
        'Magebees_Ajaxsearch' => 1,
        'Magebees_Blog' => 1,
        'Magebees_Buynow' => 1,
        'Magebees_CategoryImage' => 1,
        'Magebees_CustomCartStyle' => 1,
        'Magebees_EmailEditor' => 1,
        'Magebees_Finder' => 1,
        'Magebees_ImageFlipper' => 1,
        'Magebees_Imagegallery' => 1,
        'Magebees_Layerednavigation' => 1,
        'Magebees_MPM' => 1,
        'Magebees_Navigationmenu' => 1,
        'Magebees_Onepagecheckout' => 1,
        'Magebees_Pagebanner' => 1,
        'Magebees_ParallaxImage' => 1,
        'Magebees_ParallaxProducts' => 1,
        'Magebees_PocoBase' => 1,
        'Magebees_PocoThemes' => 1,
        'Magebees_Productlabel' => 1,
        'Magebees_Productlisting' => 1,
        'Magebees_ProductsSlider' => 1,
        'Magebees_Promotionsnotification' => 1,
        'Magebees_Responsivebannerslider' => 1,
        'Magebees_RichSnippets' => 1,
        'Magebees_Socialsharing' => 1,
        'Magebees_Testimonial' => 1,
        'Magebees_TodayDealProducts' => 1,
        'Magebees_WebImages' => 1,
        'PayPal_Braintree' => 1,

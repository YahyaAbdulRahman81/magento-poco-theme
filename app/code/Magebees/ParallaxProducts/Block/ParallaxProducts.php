<?php
namespace Magebees\ParallaxProducts\Block;

use Magento\Catalog\Api\CategoryRepositoryInterface;
use Magento\Store\Model\ScopeInterface;

class ParallaxProducts extends \Magento\Catalog\Block\Product\AbstractProduct
{
    ...
    {
		$this->setTemplate('parallax-products.phtml');

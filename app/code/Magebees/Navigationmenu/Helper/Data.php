...
class Data extends \Magento\Framework\App\Helper\AbstractHelper
{
	...
	protected $groups;
	protected $relations;
	protected $item_type_label;	protected $menu_level;
	...
	public function getCategoryUrl($cat_id,$store_id){
		$category = $this->categoryFactory->create()->setStoreId($store_id)->load($cat_id);
		//$categoryUrl = rtrim($this->url->getUrl($category->getData('url_path')), '/').$this->getConfigData(self::CATEGORY_URL_SUFFIX);
		$categoryUrl = $this->url->getUrl().$category->getData('url_path').$this->getConfigData(self::CATEGORY_URL_SUFFIX);
		return $categoryUrl;
	}

define(['jquery', 'underscore', "jquery-ui-modules/core","jquery-ui-modules/widget",'ajaxSwatchRenderer'], function ($, _) {
    'use strict';
...
params[k] = v; }
     ...
     */
    $.widget('magebees_ajaxcart.ajaxSwatchRenderer', {
        options: {
            classes: {
            ...
            productId:{},
            selectorProduct: '#popup_content',             // selector of parental block of prices and swatches (need to know where to seek for price block)
        ...
        _UpdatePrice: function () {
            ...
            $productPrice.trigger(
                'updatePrice',
                {
                    'prices': $widget._getPrices(result, $productPrice.ajaxPriceBox('option').prices)
                }
            );
        ...
        _EnableProductMediaLoader: function ($this) {
            document.getElementById('swatchImgLoader').style['display']='block';
        },
        ...
        _DisableProductMediaLoader: function ($this) {
            document.getElementById('swatchImgLoader').style['display']='none';
        },
...
$("#popup_content").find('#product-image-photo_'+this.options.productId).attr('src',img_src);
        },
...
size++; }
    ...
    return $.magebees_ajaxcart.ajaxSwatchRenderer;
});

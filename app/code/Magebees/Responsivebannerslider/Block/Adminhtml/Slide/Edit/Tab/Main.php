...
class Main extends \Magento\Backend\Block\Widget\Form\Generic implements \Magento\Backend\Block\Widget\Tab\TabInterface
{
    ...
    protected function _prepareForm()
    {
		...
		$show_offer_text = $fieldset->addField(
            'show_offer_text',
            'select',
            [
                'name' => 'show_offer_text',
                'label' => __('Show Offer Text'),
                'title' => __('Show Offer Text'),
                'required' => false,
                'values' => $this->_yesno->toOptionArray(),
          	]
        );
		$offer_text = $fieldset->addField(
            'offer_text',
            'text',
            [
                'name' => 'offer_text',
        ...
        $this->setForm($form);
		  ...
		  $this->setChild('form_after', $this->getLayout()->createBlock('Magento\Backend\Block\Widget\Form\Element\Dependence')
			...
			->addFieldMap($offer_text->getHtmlId(), $offer_text->getName())
			->addFieldMap($show_offer_text->getHtmlId(), $show_offer_text->getName())
			->addFieldDependence(
                $offer_text->getName(),
                $show_offer_text->getName(),
                1
            )
			->addFieldDependence(
                $to_date->getName(),

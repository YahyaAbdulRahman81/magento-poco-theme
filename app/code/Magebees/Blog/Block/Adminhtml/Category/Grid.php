...
class Grid extends \Magento\Backend\Block\Widget\Grid\Extended
{
    ...
    public function __construct(
        ...
        \Magebees\Blog\Model\ResourceModel\Category\Collection $categorycollection,
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn(
            ...
            [
                ...
                'index' => 'is_active',
                'type' => 'options',
				'renderer'  => 'Magebees\Blog\Block\Adminhtml\Category\Edit\Tab\Renderer\IsActive',
                'options' =>  [
                        1 => 'Enabled',
                        2 => 'Disabled'
                ]
		...
		$is_imported = $this->_helper->isImported();
		 $this->addColumn(
            ...
            [
                ...
                'index' => 'is_imported',
                'type' => 'options',
				'renderer'  => 'Magebees\Blog\Block\Adminhtml\Category\Edit\Tab\Renderer\IsImported',
               'options' =>  $is_imported
            ]
        );
		$this->addColumn(
    ...
    {
        return $this->getUrl('*/*/edit', ['category_id' => $row->getCategoryId()]);
    }

    ...
    jQuery.widget('Magebees.blog', {
         _create: function() {
            var self = this;
				...
				jQuery(".limiter-options > option").each(function(event) {
					var current_url = self.urldecode(this.value);
					this.value = current_url;
				});
				jQuery(".limiter-options").change(function(event){
					var current_url = self.urldecode(this.value);
		...
		console.log('paginationAjax inner');	
		...
		console.log('link onclick start');		
		console.log(link);							
		console.log('link onclick end');
		var url = link.attr("href");		
		console.log('url onclick start');	
		console.log(url);						
		console.log('url onclick end');	
		link.click(function () {		
		...
		ajaxLayerNav: function (url) {
			...
			jQuery.ajax({  
				...
				{		
					...
					jQuery(".product-items").trigger('contentUpdated');
					jQuery(mage.apply);			

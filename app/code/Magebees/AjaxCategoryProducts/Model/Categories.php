...
{	protected $_systemStore;	protected $_categorytree;	protected $categoryFlatConfig;
    ...
    public function buildCategoriesMultiselectValues($node, $values, $level = 0)
    {
        ...
        if ($level > 2) {
            ...
            $values[$node->getId()]['label'] = str_repeat($nonEscapableNbspChar, ($level - 3) * 5).$node->getName()." [".$node->getId()."]";
        }

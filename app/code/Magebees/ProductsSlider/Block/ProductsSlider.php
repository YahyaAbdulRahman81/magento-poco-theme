<?php
namespace Magebees\ProductsSlider\Block;

use Magento\Catalog\Api\CategoryRepositoryInterface;
use Magento\Store\Model\ScopeInterface;

class ProductsSlider extends \Magento\Catalog\Block\Product\AbstractProduct
{
    ...
    {
		$this->setTemplate('products-slider.phtml');

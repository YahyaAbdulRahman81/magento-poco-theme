...
namespace Magebees\WebImages\Model\File;
...
use Magebees\WebImages\Helper\ImageHelper;
...
class Uploader extends \Magento\Framework\File\Uploader
{
    ...
    public function checkMimeType($validTypes = [])
    {
		...
		foreach ($this->imageHelper->getSvgImageExtensions() as $extension) {
            $validTypes[] = 'text/' . $extension;
        }

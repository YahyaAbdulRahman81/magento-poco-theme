...
class Productlisting extends \Magento\Catalog\Block\Product\AbstractProduct
{
	...
	public function getSwiperinitdata($listing_id){
		...
		if((isset($this->slider_options['grid']))&&($this->slider_options['grid']=='1')):
		...
		if($navarrow):	
		$swiper_data_init['navigation']['nextEl'] = "#swiper-button-next-".$this->random_number;$swiper_data_init['navigation']['prevEl'] = "#swiper-button-prev-".$this->random_number;
		endif;	
		...
		$swiper_data_init['breakpoints']['1200']['grid']['rows'] = 2;
		$swiper_data_init['breakpoints']['1200']['grid']['fill'] = 'row'|'column';
		$swiper_data_init['breakpoints']['1440']['grid']['rows'] = 2;
		$swiper_data_init['breakpoints']['1440']['grid']['fill'] = 'row'|'column';
		$swiper_data_init['breakpoints']['1920']['grid']['rows'] = 2;
		$swiper_data_init['breakpoints']['1920']['grid']['fill'] = 'row'|'column';
		endif;

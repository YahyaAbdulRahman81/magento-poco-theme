...
class Edit extends \Magento\Backend\App\Action
{
    ...
    public function execute()
    {
        ...
        $this->_coreRegistry->register('productlisting_data', $model);
        $resultPage = $this->_initAction();
        $resultPage->addBreadcrumb(
            $id ? __('Edit Product Listing') : __('Add Product Listing'),
            $id ? __('Edit Product Listing') : __('Add Product Listing')
        );
        $resultPage->getConfig()->getTitle()->prepend(__('Magebees'));
        $resultPage->getConfig()->getTitle()->prepend(__('Products Listing'));
        $resultPage->getConfig()->getTitle()->prepend(__('Manage Product Listing'));
        $resultPage->getConfig()->getTitle()
            ->prepend($model->getId() ? $model->getTitle() : __('Add Product Listing'));

(function (factory) {
    ...
    var _scrollTop = jQueryMagebees.fn.scrollTop; // preserve original function

    jQueryMagebees.cssHooks["pageYOffset"] = {
    ...
    jQueryMagebees.fn.scrollTop = function (value) {
    ...
    var _scrollLeft = jQueryMagebees.fn.scrollLeft; // preserve original function
    ...
    jQueryMagebees.fn.scrollLeft = function (value) {
        if (typeof value == "undefined") {
            var nice = (this[0]) ? $.data(this[0], '__nicescroll') || false : false;
    ...
    jQueryMagebees.fn.getNiceScroll = function (index) {
    ...
    jQueryMagebees.extend(jQueryMagebees.expr[':'], {
        nicescroll: function (a) {
            return ($.data(a, '__nicescroll')) ? true : false;
        }
    });

    jQueryMagebees.fn.niceScroll = function (wrapper, opt) {
        ...
        opt = jQueryMagebees.extend({}, opt); // cloning

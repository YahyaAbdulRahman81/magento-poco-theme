define(
    [
        ...
        'Magebees_Onepagecheckout/js/action/set-additional-information',
        'mage/calendar'
    ],
    function ($, ko, Component, quote, setAdditionalInformationAction, calendar) {
        ...
        var hsOscGiftwrap = ko.observable((quote.getTotals().magebees-Onepagecheckout_giftwrap_amount) ? true : false);
        var canShowSurveyOther = ko.observable(false);

        return Component.extend({
            defaults: {
                template: 'Magebees_Onepagecheckout/additional'
            },
            ...
            initialize: function () {
                ...
                if(this.canShowDeliveryDate) {
                    $("#magebees-Onepagecheckout-delivery-date").calendar({
                        showsTime: false,
                        dateFormat: "M/d/yy",

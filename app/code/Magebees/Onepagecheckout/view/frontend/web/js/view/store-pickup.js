define([
    ...
    return Component.extend({
        defaults: {
            template: 'Magebees_Onepagecheckout/store-pickup',
            deliveryMethodSelectorTemplate: 'Magebees_Onepagecheckout/delivery-method-selector',
            isVisible: false,
            isAvailable: false,
        ...
        selectStorePickup: function () {
			//alert(this.getStorePickupSource());

...
namespace Magebees\Ajaxquickview\Block\Product\Renderer;
    ...
    \Magento\Framework\DataObject\IdentityInterface
{
     ...
     */
    const SWATCH_RENDERER_TEMPLATE = 'Magebees_Ajaxquickview::product/view/renderer.phtml';

    /**
     * Path to default template file with standard Configurable renderer.
     */
    const CONFIGURABLE_RENDERER_TEMPLATE = 'Magebees_Ajaxquickview::product/view/type/options/configurable.phtml';

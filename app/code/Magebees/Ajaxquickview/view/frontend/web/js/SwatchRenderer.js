...
define(['jquery', 'underscore', 'jquery-ui-modules/core','jquery-ui-modules/widget','quickviewSwatchRenderer'], function ($, _) {
    'use strict';
    ...
    $.widget('magebees_ajaxquickview.quickviewSwatchRenderer', {
        ...
        _create: function () {
            ...
            var options = this.options,
                gallery = $('[data-gallery-role=gallery-placeholder]', '.product.media'),
